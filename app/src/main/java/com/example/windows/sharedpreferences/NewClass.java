...
public class NewClass extends AppCompatActivity {
    ...
    private String sharedPreferenceDatabaseKey = "sharedPreferences";
    ...
    public void saveData() {
        SharedPreferences sharedPreferences = getSharedPreferences(sharedPreferenceDatabaseKey, MODE_PRIVATE);
